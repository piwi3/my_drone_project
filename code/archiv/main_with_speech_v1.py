    ...
    async def main():
        ...
        async with websockets.connect(
            ...
            async def drone_control():
                global command, drone_is_on, prv_error, PID, FB_CENTER, RES
                while drone_is_on:
                    ...
                    # Giving the other processes time to work (speech recognition)
                    await asyncio.sleep(0.001)
        
            send_result, receive_result, webcam_result = await asyncio.gather(send(), receive(), drone_control())
